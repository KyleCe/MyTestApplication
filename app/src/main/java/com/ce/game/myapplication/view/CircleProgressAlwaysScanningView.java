 ...
 * @author: KyleCe
 */
public class CircleProgressAlwaysScanningView extends CircleProgressView implements Handler.Callback {

    protected Handler mHandler;
    private final int START_ANIMATION = 786;
    private int mRepeatCount = 0;
    private int mMaxRepeatCount = 12;
    ...
    protected RefreshUiStatusCallbackWithArg mRefreshUiStatusCallback = RefreshUiStatusCallbackWithArg.NULL;

    public CircleProgressAlwaysScanningView(Context context) {
        this(context, null);
    }

    public CircleProgressAlwaysScanningView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleProgressAlwaysScanningView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int deciderProgress = mComplete ? (int) mProgress : mCurrentProgress;

        mRefreshUiStatusCallback.onRefreshUi(deciderProgress);
    ...
    public void setRefreshUiStatusCallback(RefreshUiStatusCallbackWithArg refreshUiStatusCallback) {
        mRefreshUiStatusCallback = refreshUiStatusCallback;
    }
    ...
    public void endingProcess() {
        ...
        mComplete = true;
        setStartProgress(mCurrentProgress);
        int repeatFactor = 0 < mTargetProgress && mTargetProgress < CircleProcessSlaver.DEFAULT_COMPLETE_PROCESS
                ? (int) ((CircleProcessSlaver.DEFAULT_COMPLETE_PROCESS - mTargetProgress) / 20.f) : 3;
