...
public class RippleView extends RelativeLayout {
    ...
    public void draw(Canvas canvas) {
        ThreadLocal<Boolean> rippleAnimationEndExecuted = new ThreadLocal<>();
        rippleAnimationEndExecuted.set(false);
        try {
            super.draw(canvas);
            if (animationRunning) {
                if (DURATION <= timer * FRAME_RATE) {
                    if (mAnimationListener != null) {
                        ...
                        rippleAnimationEndExecuted.set(true);
                    }
            ...
            if (mAnimationListener != null && !rippleAnimationEndExecuted.get()) {
                mAnimationListener.onRippleAnimationEnd();
            }
        }
    }
